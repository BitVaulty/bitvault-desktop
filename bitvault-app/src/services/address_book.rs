...
impl AddressBookService {
    ...
    pub fn add_address(&self, vault_address: &str, address: String, label: Option<String>) -> Result<(), String> {
    ...
    pub fn update_label(&self, vault_address: &str, address: &str, label: Option<String>) -> Result<(), String> {
        let mut data = self.load_address_book(vault_address)?;
